...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/pictureSlide.js" ></script>
</head>
</head>
<body>
<!--顶部区域 start-->
...
<table width="1200" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td height="95"><a href="${pageContext.request.contextPath}/mall/toIndex"><img src="../images/logo.jpg"></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ce2626" >
    <tr>
        <td><table width="1200" border="0" cellspacing="0" cellpadding="4" align="center" class="nav_font16">
            <tr>
                <td width="200">&nbsp;</td>
                <td width="80" align="center" class="nav_active"><a href="${pageContext.request.contextPath}/mall/toIndex" class="white">首页</a></td>
